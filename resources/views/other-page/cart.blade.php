...
<body>
    <div class="container">
        <div class="shopping-cart">
                        ...
                        <div class="cart-item" id="item-{{ $id }}">
                            ...
                            <div class="item-details">
                                ...
                                <div class="item-controls">
                                    ...
                                    <button onclick="updateQuantity('item-{{ $id }}', -1)">-</button>
                                    <span class="item-price" id="item-{{ $id }}-price" data-unit-price="{{ $details['price'] }}">Rp{{ number_format($details['price'], 2) }}</span>
            ...
            <p>Total : <span id="total">Rp{{ number_format($total, 2) }}</span></p>
        </div>
